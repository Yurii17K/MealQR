...
public class DishController {
    ...
    public ResponseEntity<DishRes> removeDishFromRestaurantOffer(@RequestParam String dishName, Principal principal) {
        return dishService.removeDishFromRestaurantOffer(dishName, principal.getName())
                .map(ResponseEntity::ok)//
                .getOrElseThrow(ApiException::new);
    }
}