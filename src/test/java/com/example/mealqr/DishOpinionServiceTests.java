...
//                DISH_RATING_REQ.getRestaurantId())).thenReturn(Option.none());
//        //when
...
//        //given
//        when(dishRepository.findByDishNameAndRestaurantName(DISH_RATING_REQ.getDishName(),
//                DISH_RATING_REQ.getRestaurantId())).thenReturn(Option.of(DISH));
...
//                DISH_COMMENT_REQ.getRestaurantId())).thenReturn(Option.none());
//        //when
...
//        //given
//        when(dishRepository.findByDishNameAndRestaurantName(DISH_COMMENT_REQ.getDishName(),
//                DISH_COMMENT_REQ.getRestaurantId())).thenReturn(Option.of(DISH));
